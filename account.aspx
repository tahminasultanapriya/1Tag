<%@ Page Language="C#" AutoEventWireup="true" CodeFile="account.aspx.cs" Inherits="account.membership" %>
   ...
   <asp:TemplateField>
    ...
    <div class="divRight" style="float: right; height: 930px; margin-right:35px;">
        ...
        <div style="margin-top:200px;margin-bottom: 60px; height: 300px; width: 707px;">
            <div>
                <p style="text-align: justify; font-family: &quot;Courier New&quot;, Courier, monospace; font-size: 25px"> Show Your Posts 
