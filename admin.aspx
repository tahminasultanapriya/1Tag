...
<div class="nav1" style=" list-style-position: inside; height: 50px; width: 100%; background-color: #33CC33; margin-top:-35px;">
    			...
    			<li><a href="http://localhost:2382/WebSite2/Home.aspx" style="color:black;background-color:#c0c0c0;">Home</a></li>
                <li class="dropdown">
...
<asp:GridView ID="GridView2" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
    ...
    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="179px" Width="638px">
