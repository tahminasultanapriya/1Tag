...
public partial class admindeleteaccount : System.Web.UI.Page
{
    ...
    static DataTable BindRepeater()
    {
        ...
        var con = new SqlConnection(ConfigurationManager.ConnectionStrings["connect"].ToString());
        con.Open();
        var da = new SqlDataAdapter("Select * from reg", con);
    ...
    protected void DeleteCustomer(object sender, EventArgs e)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("Delete from reg WHERE id = @Id", con2))
            {
