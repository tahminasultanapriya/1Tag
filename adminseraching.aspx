<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminseraching.aspx.cs" Inherits="adminseraching" %>
<style>
    ...
    <ul style="width: 100%; background-color: #000000; color: #FFFFFF; height: 62px;">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="http://localhost:2382/WebSite2/nonregusers.aspx" style="background-color:#33cc33;">Non Registered</a>
   			  	...
   			  	<li class="dropdown">
                <a href="javascript:void(0)" class="dropbtn" style="color:black;background-color:#c0c0c0;">Tags <i class="fa fa-angle-down" style="font-size:20px;color:grey"></i></a>
                <div class="dropdown-content">
                ...
                <li><a href="http://localhost:2382/WebSite2/admindeleteaccount.aspx" style="color: white">Search</a></li>
                <li><asp:Button ID="Button1" runat="server" Text="Button" style="color: white; background-color: red;" OnClick="logout" Height="61px" Width="166px" /></li>                                    
   			    </ul>
      ...
      <div>
             <li class="dropdown">
                <a href="javascript:void(0)" class="dropbtn" style="color:black;background-color:#c0c0c0;">Tags <i class="fa fa-angle-down" style="font-size:20px;color:grey"></i></a>
                <div class="dropdown-content">
                    <a href="http://localhost:2382/WebSite2/regtags.aspx">user</a>
                    <a href="http://localhost:2382/WebSite2/nonregtags.aspx">tag</a>
                </div>
                </li>
      </div>
            <div>
      ...
      <script type="text/javascript">
          function search1() {
              ...
              xmlhttp.open("GET", "byusersearch.aspx?opr=search&nm1=" + document.getElementById("t1").value, false);
              xmlhttp.send(null);
