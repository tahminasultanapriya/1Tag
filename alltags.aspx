<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alltags.aspx.cs" Inherits="alltags" %>
...
<div class="nav1" style=" list-style-position: inside; height: 50px; width: 100%; background-color: #33CC33; margin-top:-35px;">
                ...
                <li class="dropdown">
                <a href="javascript:void(0)" class="dropbtn" style="color: #FFFFFF">Users<i class="fa fa-angle-down" style="font-size:20px;color:grey"></i></a>
                <div class="dropdown-content">
                    <a href="#"  style="background-color:#33cc33;">Registered</a>
                    <a href="#">profile.aspx">Non Registered</a>
                </div>
                </li>
                <li class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="http://localhost:2382/WebSite2/showdetails.aspx">Registered</a>
                    <a href="http://localhost:2382/WebSite2/editprofile.aspx">Non Registered</a>
                </div>
                </li>
