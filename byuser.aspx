<%@ Page Language="C#" AutoEventWireup="true" CodeFile="byuser.aspx.cs" Inherits="byuser" %>
    ...
    <ul style="width: 100%; background-color: #000000; color: #FFFFFF; height: 62px;">
      ...
      <script type="text/javascript">
          function search1() {
              ...
              xmlhttp.open("GET", "byuser.aspx?opr=search&nm1=" + document.getElementById("t1").value, false);
              xmlhttp.send(null);
