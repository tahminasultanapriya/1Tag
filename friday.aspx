<%@ Page Language="C#" AutoEventWireup="true" CodeFile="friday.aspx.cs" Inherits="friday" %>
...
<body  style="background-image:url(team1.jpg); background-position:top; background-repeat:no-repeat; background-attachment:fixed;">
    <form id="form1" runat="server">
            <div class="formDesign">
                <div class="topnav" style="padding-top: 0px; margin-top: 0px; width: 100%; background-color: #009933;">
			  	<ul>
    			<li style="margin-bottom: 0px"><a href="http://localhost:2382/WebSite2/Home.aspx" style="color: #FFFFFF">Home</a></li>
         ...
         <div style="text-align: center; width: 100%; padding-left: 18%;">
             <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataKeyField="Id" DataSourceID="SqlDataSource1" GridLines="Horizontal" style="text-align: left; margin-left: 108px">
                 ...
                 <ItemTemplate>
                     ...
                     <table class="auto-style12" style=" background-color: #009933; height: 56px;">
                         <tr>
                             <td class="auto-style13">Tag&nbsp; :
  ...
  <table style="width: 20%; height: 288px; margin-top: 0px;float:right">
                        <tr>
      ...
      <tr>
                    ...
                    <tr>
                        <td class="auto-style3">Usernamed>
                        <td class="auto-style4">
                    ...
                    <tr>
                        ...
                        <td class="auto-style8">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dataCS %>" SelectCommand="SELECT * FROM [Comment2]"></asp:SqlDataSource>
                        </td>
                    </tr>
                    <tr>
