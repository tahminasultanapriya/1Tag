<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nonregtags.aspx.cs" Inherits="nonregtags" %>
<style>
...
<div class="nav1" style=" list-style-position: inside; height: 50px; width: 100%; background-color: red; margin-top:-35px;">
    <ul style="width: 100%; background-color: #000000; color: #FFFFFF; height: 62px;">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="http://localhost:2382/WebSite2/nonregtags.aspx" style="background-color:#33cc33;">Non Registered</a>
                </div>
                </li>
...
<div style="width:100%;background-color:#c0c0c0;">
    ...
    <ItemTemplate>
        <tr style="height:50px; width:100%;">
            ...
            <td>
                <asp:Label ID="lblUserTag" runat="server" Text='<%# Eval("Date") %>' />
            </td>
            <td>
    ...
    <p>
        <input id="t1" onkeyup="search1();" type="text" /><input type="button" id="b5" value="search" /></p>
    <p>
        &nbsp;</p>
            <div id="d1"></div>
