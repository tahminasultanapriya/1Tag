<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nonregusers.aspx.cs" Inherits="nonregusers" %>
...
<div class="nav1" style=" list-style-position: inside; height: 50px; width: 100%; background-color: #33CC33; margin-top:-35px;">
    			...
    			<li><a href="http://localhost:2382/WebSite2/admin.aspx" style="color: #FFFFFF;background-color:black;">Home</a></li>
                <li class="dropdown">
                <a href="javascript:void(0)" class="dropbtn" style="color: #FFFFFF; background-color:black;">Admin <i class="fa fa-angle-down" style="font-size:20px;color:grey"></i></a>
                <div class="dropdown-content">
                    ...
                    <a href="http://localhost:2382/WebSite2/changeadminpassword.aspx " >Change Password</a>
   			  	...
   			  	<li><a href="http://localhost:2382/WebSite2/admin.aspx" style="color: white;background-color:black;">Upload File</a></li>
                <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="http://localhost:2382/WebSite2/nonregusers.aspx" style="background-color:#33cc33;">Non Registered</a>
                </div>
                </li>
                <li class="dropdown">
                <a href="javascript:void(0)" class="dropbtn" style="color:white;">Tags <i class="fa fa-angle-down" style="font-size:20px;color:grey"></i></a>
                <div class="dropdown-content">
                ...
                <li><a href="http://localhost:2382/WebSite2/admindeleteaccount.aspx" style="color: white;background-color:black;">Delete Account</a></li>
