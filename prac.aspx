...
<a href="#"><input type = "text" value = "reply" name = "dreply" id = "inner_reply"></a>
          ...
          <tr style="background-color:#EBEFF0">
            <td>
             <table style="background-color:#EBEFF0;border-top:1px dotted #df5015; width:960px" >
                 <tr>
                ...
                <tr>
                 <td>
                   Subject:
                   <asp:Label ID="lblSubject" runat="server" Text='<%#Eval("tag") %>' Font-Bold="true"/>
                 </td>
                </tr> 
             </table> 
            </td> 
          ...
          <tr>
           <td>
            <asp:Label ID="lblComment" runat="server" Text='<%#Eval("com") %>'/>
           </td>
          </tr>
        <tr>
         <td>
           <table style="background-color:#EBEFF0;border-top:1px dotted #df5015;border-bottom:1px solid #df5015; width:960px" >
            <tr>
