<%@ Page Language="C#" AutoEventWireup="true" CodeFile="regtags.aspx.cs" Inherits="regtags" %>
...
<div class="nav1" style=" list-style-position: inside; height: 50px; width: 100%; background-color: #33CC33; margin-top:-35px;">
                ...
                <div class="dropdown-content">
                    <a href="http://localhost:2382/WebSite2/regtags.aspx" style="background-color:#33cc33;">Registered</a>
...
<div style="width:100%;background-color:#c0c0c0;">
    ...
    <ItemTemplate>
        <tr style="height:50px; width:100%;">
            ...
            <td>
                <asp:Label ID="lblUserTag" runat="server" Text='<%# Eval("tag") %>' />
            </td>
            <td>
                <asp:Label ID="lblUserCom" runat="server" Text='<%# Eval("com") %>' />
            </td>
            <td>
                <asp:Label ID="lblUserDate" runat="server" Text='<%# Eval("date") %>' />
            </td>
            <td>
