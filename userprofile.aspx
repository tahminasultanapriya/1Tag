<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userprofile.aspx.cs" Inherits="Comment_using_repeater.userprofile" %>
...
<div class="nav1" style=" list-style-position: inside; height: 50px; width: 100%; background-color: red; margin-top:-35px;">
                ...
                <li style="color: #FFFFFF"><a href="http://localhost:2382/WebSite2/userprofile.aspx" style="color: black; background-color:#c0c0c0; " >Profile</a></li>
                <li class="dropdown">
...
<section>
    ...
    <div class="two1" style="background-color:#c0c0c0;">
          <table style="margin-left:140px; height: 467px;">
             <tr>
                 <td colspan="2">
                     <div style="text-align: center; font-size: 50px; font-style: italic; background-color:#c0c0c0; font-weight: bold; font-family: Arial, Helvetica, sans-serif">
                     <h2 style="width: 501px; font-weight: bold; background-color:#c0c0c0; font-style: oblique; font-family: Arial, Helvetica, sans-serif; font-size: 40px; height: 69px;">
                         My Profile
                     </h2>
                     </div>
...
<div style="text-align: center; font-size: 50px; margin-left:30%; margin-top:35%; font-style: italic; background-color:#c0c0c0; font-weight: bold; font-family: Arial, Helvetica, sans-serif;">
<h2 style="width: 501px; font-weight: bold; background-color:#c0c0c0; text-align:center; font-style: oblique; font-family: Arial, Helvetica, sans-serif; font-size: 40px; height: 69px;">
    My Tags
</h2>
</div> 
            ...
            <div class="panel panel-white post panel-shadow">
                <div class="post-heading">
                    ...
                    <div class="pull-left meta">
                        <div class="title h5">
                            <a href="#"><b>
                               <asp:Label ID="Label9" runat="server" Font-Bold="true" Text='<%#Eval("username") %>'/>
                                </b></a>
                            made a post.
                               # Post Id <asp:Label ID="Label10" runat="server" Font-Bold="true" Text='<%#Eval("Id") %>'/>
                        </div>
